...
Original file is located at
    https://colab.research.google.com/drive/10HSvaR_EuoW_L8qTdBFZpZDVebUOGhgB
"""
...
#filling the model on training dataset
model.fit(X_train, y_train)

#doing the prediction on test data
prediction=model.predict(X_test)

#doing the prediction on train data
prediction1 = model.predict(X_train)

#printing the classification_report to check accuracy of our model
...
#We are getting 80% accuracy on training data and 76% on test data
